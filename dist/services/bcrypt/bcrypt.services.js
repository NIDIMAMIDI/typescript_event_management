...
const passwordChecking = (plainTextPassword, hashedPassword) => __awaiter(void 0, void 0, void 0, function* () {
    return yield bcrypt.compare(plainTextPassword, hashedPassword);
});
